...
import com.example.notepadappcleanarchitechure.feature_note.presentation.notes.components.NoteItem
import com.example.notepadappcleanarchitechure.feature_note.presentation.notes.components.OrderSection
    ...
    Scaffold (
        ...
        Column (modifier = Modifier.padding(16.dp).fillMaxSize()) {
            Row (
                ...
                IconButton(
                    onClick = {
                        viewModel.onEvent(NotesEvent.ToggleOrdeSection)
                    },
                ) {
                    Icon(
